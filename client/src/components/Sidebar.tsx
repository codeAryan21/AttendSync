    ...
    <div className={`${isCollapsed ? 'w-16' : 'w-64'} bg-white shadow-lg h-full flex flex-col transition-all duration-300 ease-in-out`}>
      ...
      <div className="p-4 border-t border-gray-200 space-y-2">
        <button
          ...
          className={`w-full px-3 py-2 text-sm bg-indigo-500 text-white rounded-md hover:bg-indigo-600 transition-colors flex items-center ${isCollapsed ? 'justify-center' : 'justify-center space-x-2'}`}
        >
